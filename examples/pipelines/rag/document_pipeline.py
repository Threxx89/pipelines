...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                "pipelines": ["*"],                                                         
                "FILE_PATH": os.getenv("FILE_PATH", "E:\\t5g-dev\\ProdApiJava2.0\\com.tap.t3g.fr.api.http\\docs"),                   
                "LLM_NAME": os.getenv("LLM_NAME", "llama3.1:8b-instruct-q8_0")            
            }
        )
    ...
    async def on_startup(self):
        ...
        reader = SimpleDirectoryReader(self.valves.FILE_PATH)
    ...
    def pipe(
        ...
        llm = OpenAI(temperature=0, model=self.valves.LLM_NAME)
