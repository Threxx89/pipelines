    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "DB_TABLE": os.getenv("DB_TABLE", "poop10p,poop11p,poms09p"),                            # Table(s) to run queries against 
                ...
                "TEXT_TO_SQL_MODEL": os.getenv("TEXT_TO_SQL_MODEL", "deepseek-r1:32b-qwen-distill-q4_K_M")            # Model to use for text-to-SQL generation      
            }
        )
