...
#E:\\t3g-doc-root\\test\\llama3.2:3b-instruct-fp16
    ...
    async def on_startup(self):
        ...
        #    request_timeout=720.0, context_window=30000
        #    # api_key="AIzaSyDKv11PLOQU8E_F2kPnz6LICdCfbyykBFs",  # uses GOOGLE_API_KEY env var by default
        #)
        #llm = Groq(model="deepseek-r1-distill-llama-70b", api_key="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")
        Settings.llm = Groq(model="llama3-70b-8192", api_key="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")
        ...
        chroma_client = chromadb.PersistentClient("./chroma03.db")
