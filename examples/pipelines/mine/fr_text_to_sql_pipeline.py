...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "DB_DATABASE": os.getenv("DB_DATABASE", "U0000fr"),                          # Database to select on the DB instance
    ...
    def pipe(
       ...
       # sql_database = SQLDatabase(self.engine, include_tables=table_names)
        sql_database = SQLDatabase(self.engine, include_tables=["reservation"])
        ...
        text_to_sql_prompt = """
        You are a database expert and have been asked to retrieve information from a database.  
